                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-20">
                    <div className="animate-slide-up">
                        ...
                        <p className="text-[#082f49] text-lg mb-6 leading-relaxed font-medium">
                            MoveSafe Packers & Movers delivers reliable packing and moving services with a customer-first approach. MoveSafePackers has evolved from a local transport provider to one of India's most trusted logistics partners. Our team prioritizes safety, integrity, and seamless relocations for households and businesses across India. With experienced staff and quality materials, MoveSafe ensures hassle-free shifts, building trust through consistent, on-time service. With over a decade of experience, we bridge the gap between complex logistics and personalized care.
                        </p>
                ...
                <div className="border-t border-b border-gray-100 py-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <h4 className="text-black font-bold mb-1">Quality Assurance</h4>
